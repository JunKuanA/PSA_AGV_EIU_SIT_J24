...
public class LoopDetectionDtec implements Runnable{
    ...
    public LoopDetectionDtec(persistenceManager persistenceManager,ESBClient esbClient, HashMap<String, Object> hmDbParam, OpcUaClient opcUaClient) {
    ...
    public LoopDetectionDtec(persistenceManager persistenceManager, HashMap<String, Object> hmDbParam, OpcUaClient opcUaClient) {
        this.persistenceManager = persistenceManager;
        this.opcUaClient = opcUaClient;
        this.hmDbParam = hmDbParam;
        if (hmDbParam.size()>0){hmDbParam.clear();}
    ...
    public void run() {
        while(true){
            try {
                ...
                sJsonReturnMsg = "";
                sReplyTransID = "";
                logger.info("Inside LoopDetectionDtec Thraed");
                ...
                logger.info(String.format("Inside LoopDetectionDtec Thraed:     OPC_UA.TL_EWT_Loop = " + OPCUAWagoHM.OPCUAHm.get("|var|WAGO 750-8212 PFC200 G2 2ETH RS XTR.Application.OPC_UA.TL_EWT_Loop")));
                logger.info(String.format("Inside LoopDetectionDtec Thraed:     OPC_UA.TL_NT_Loop = " + OPCUAWagoHM.OPCUAHm.get("|var|WAGO 750-8212 PFC200 G2 2ETH RS XTR.Application.OPC_UA.TL_NT_Loop")));
