...
@Entity
@Table(name = "jc_enq_info")
@XmlRootElement
@NamedQuery(name = "jc_enq_info.findByEventDt", query = "SELECT a FROM jc_enq_info a WHERE a.jc_enq_info_pk.event_dt = :eventDt")
public class jc_enq_info implements Serializable{
    private static final long serialVersionUID = 1L;

    @EmbeddedId
    protected embeddedPK jc_enq_info_pk;
    ...
    public embeddedPK getJc_enq_info_pk() {
        return jc_enq_info_pk;
    }
    public void setJc_enq_info_pk(embeddedPK jc_enq_info_pk) {
        this.jc_enq_info_pk = jc_enq_info_pk;
    }
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((jc_enq_info_pk == null) ? 0 : jc_enq_info_pk.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        jc_enq_info other = (jc_enq_info) obj;
        if (jc_enq_info_pk == null) {
            if (other.jc_enq_info_pk != null)
                return false;
        } else if (!jc_enq_info_pk.equals(other.jc_enq_info_pk))
            return false;
        if (source_m == null) {
    ...
    public String toString() {
        return "jc_enq_info [jc_enq_info_pk=" + jc_enq_info_pk + "]";
    }
